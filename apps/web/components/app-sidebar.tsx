...
import { SidebarCommandPalette } from "./command-palette";
...
export function AppSidebar({
  ...
  const canManageUsers = useIsAdmin();
  ...
  const isLandingPageActive = pathname.startsWith("/landing-page-trackers");
  ...
  return (
    <SidebarProvider>
      <Sidebar className="h-full">
        ...
        <SidebarCommandPalette onNavigate={onRequestClose} />
        ...
        <SidebarContent className="scrollbar-none overscroll-contain">
          ...
          <SidebarGroup title="Operations & Supply Chain">
            <SidebarCollapsibleItem
              icon={Warehouse}
              label="Warehouse"
        ...
        <SidebarFooter>
          <SidebarSignOut onSignOut={logout} />
        </SidebarFooter>
      </Sidebar>
    </SidebarProvider>
  );
