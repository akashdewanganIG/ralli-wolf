...
/**
 * Review slides laid over the foot of the sign-in video.
 *
 ...
 *
 * The panel is solid, not translucent: the footage behind it changes every
 * frame, and only an opaque backing keeps small text reliably legible over
...
export default function LoginReviews() {
  ...
  return (
    <div className="pointer-events-none absolute inset-x-0 bottom-0 p-4 sm:p-5">
      <div className="pointer-events-auto rounded-xl border border-border bg-surface p-4 sm:p-5">
        {/* Slides are stacked so the panel keeps one height as the copy
            changes length, rather than resizing on every rotation. */}
        <div className="relative min-h-[7.5rem]">
          {REVIEWS.map((review, i) => (
            ...
            >
              ...
              <blockquote className="mt-2.5 text-sm leading-relaxed text-foreground">
                “{review.quote}”
              </blockquote>
