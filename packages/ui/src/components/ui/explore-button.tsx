...
>(({ children, className, showIcon = true, ...props }, ref) => {
  return (
    ...
    >
      ...
      {showIcon && (
        <svg
          className="w-6 h-6 justify-end ease-linear duration-300 rounded-full border border-border p-1.5 rotate-45 group-hover:rotate-90 group-hover:bg-surface-elevated group-hover:border-none"
          viewBox="0 0 16 19"
