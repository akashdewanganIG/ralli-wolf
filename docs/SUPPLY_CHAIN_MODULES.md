...
| Routes             | `apps/api/src/routes/supplyChain.routes.ts`, mounted in `routes/index.ts`                                                   |
| Scheduled jobs     | `apps/api/src/jobs/inventoryScheduler.ts`                                                                                   |
| Web types/services | `apps/web/lib/api/types/supplyChain.ts`, `apps/web/lib/api/supplyChainServices.ts`                                          |
| Web hooks          | `apps/web/hooks/useSupplyChain.ts`                                                                                          |
| Web pages          | `apps/web/app/{inventory,materials,warehouse,bom,purchasing,production}/` — 34 routes                                       |
| Navigation         | `apps/web/components/appSidebar.tsx`                                                                                        |
...
| ------------------------------- | ----------------- | ------------------------------------ |
| `INVENTORY_ALERT_INTERVAL_MS`   | `900000` (15 min) | Reorder/expiry sweep interval        |
| `RESERVATION_SWEEP_INTERVAL_MS` | `3600000` (1 hr)  | Expired-reservation release interval |
...
it. Do not run it against production.
